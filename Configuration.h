 ...
 * Choose your version:
 */
// normal size K200 or plus K280?
// 0 ... K200
// 1 ... K280
#define HE3D_Plus 1

// HE3D Probe (pezio) 1 or Custom 2; 0 for no probe
#define HE3D_PROBE_VERSION 1

// Heated Bed:
// 0 ... no heated bed
// 1 ... aluminium heated bed with "BuildTak-like" sticker
// 2 ... glass heated bed
#define HE3D_ENABLE_BED 2
...
#define STRING_CONFIG_H_AUTHOR "TekkieDad, HE3D K200/K280, Created 7/31/2019" // Who made the changes.
...
#if HE3D_Plus >0
	#define CUSTOM_MACHINE_NAME "HE3D K280"
#else
	#define CUSTOM_MACHINE_NAME "HE3D K200"
#endif
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // HE3D - run 'M106 S255' & 'M303 E0 C10 S200'
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #if HE3D_ENABLE_BED == 1
																									  
    #define DEFAULT_bedKp 374.03
    #define DEFAULT_bedKi 72.47
    #define DEFAULT_bedKd 482.59
  #elif HE3D_ENABLE_BED == 2

    // Values for Glass Bed		
					
    #define DEFAULT_bedKp 209.82
    #define DEFAULT_bedKi 39.40
 ...
 */
//===========================================================================
//================ Custom section to configure M600 easier ==================
//===========================================================================

//Use this section to define the type of setup for M600 load/unload distance.

// Direct Drive or Bowden?
// 0 ... Direct Drive
// 1 ... Bowden
#define FEED_STYLE 1
#define THROAT_LENGTH 25  //Top of throat to nozzle tip //

	#if FEED_STYLE > 0  // BOWDEN SECTION
		#define BOWDEN_LENGTH 650   //Length of Bowden tube from extruder gear to beginning of throat//
		#define TOTAL_EXT ((BOWDEN_LENGTH) + (THROAT_LENGTH))
		#define EXTRUDE_MAXLENGTH ((TOTAL_EXT)+10)
	  //===========================================================================

	#else  // DIRECT DRIVE SECTION
		#define BOWDEN_LENGTH 0   //Length of Bowden tube from extruder gear to beginning of throat//
		#define TOTAL_EXT ((BOWDEN_LENGTH) + (THROAT_LENGTH))
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    //#define DELTA_SMOOTH_ROD_OFFSET 226   // (mm)
    // Horizontal offset of the universal joints on the end effector.
    //#define DELTA_EFFECTOR_OFFSET 5      // (mm)
    // Horizontal offset of the universal joints on the carriages.
    //#define DELTA_CARRIAGE_OFFSET 28.6    // (mm)
    // Horizontal distance bridged by diagonal push rods when effector is centered.
    #define DELTA_RADIUS 179.0          // (mm) Get this value from G33 auto calibrate
    // Distance between bed and nozzle Z home position
    #define DELTA_HEIGHT 640.00             // (mm) Get this value from G33 auto calibrate
//===========================================================================
//===========================================================================

  #else // (k200) Need to verify measuements
    // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
    #define DELTA_PRINTABLE_RADIUS 100.0   // (mm)
    // Center-to-center distance of the holes in the diagonal push rods.
    #define DELTA_DIAGONAL_ROD 218.0      // (mm)
    // Horizontal distance bridged by diagonal push rods when effector is centered.
    #define DELTA_RADIUS 112.0             // (mm) Get this value from G33 auto calibrate
    // Distance between bed and nozzle Z home position
...
#define Z_MIN_ENDSTOP_INVERTING (HE3D_PROBE_VERSION + 0 == 1) // V1 is NO, V2 is NC
...
#if HE3D_PROBE_VERSION == 2
  #define Z_PROBE_OFFSET_FROM_EXTRUDER 0  // Z offset: -below +above  [the nozzle]
#elif HE3D_PROBE_VERSION == 1
  #define Z_PROBE_OFFSET_FROM_EXTRUDER 0  // Z offset: -below +above  [the nozzle]
#else
  #define Z_PROBE_OFFSET_FROM_EXTRUDER 0    // Z offset: -below +above  [the nozzle]
#endif
